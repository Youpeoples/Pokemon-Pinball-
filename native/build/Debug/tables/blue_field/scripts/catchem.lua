--[[
  Blue Field - Catch'em Mode State Machine
  Original: native/src/game/blue_field.c (check_special_mode_collision state 0)
  ...
  Wild Pokemon Availability:
    ...
    - See data/blue_wild_mons.asm for availability tables
    - Blue Field uses different initial maps than Red Field:
      Starting maps: Viridian City, Viridian Forest, Mt. Moon,
                     Cerulean City, Vermilion City, Rock Tunnel,
                     Celadon City
